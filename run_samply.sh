...
samply record --profile-name proxylb_profile --save-only -o profile.json ./target/release/proxylb -c ./bench/bench_config.yaml --log-level info > bench.log 2>&1 &
PROXYLB_PID=$!
sleep 3
